...
export default function FacilityAnalysis({ data }: { data: DashboardData }) {
  ...
  useEffect(() => {
    ...
    const chart = echarts.init(treemapRef.current, 'dark');
      ...
      series: [{
        ...
        levels: [
          ...
          },
          {
            ...
            color: ['#4ade80', '#facc15', '#ff9f43', '#ff5c5c'],
          },
        ],
        data: treeData,
      }],
  ...
  useEffect(() => {
    ...
    const chart = echarts.init(subgroupRef.current, 'dark');
  ...
  return (
    <div ref={containerRef} className="space-y-4">
      {/* Alert Banner */}
      <div className="card-border p-5 border-l-4" style={{ borderLeftColor: '#ff5c5c', background: 'linear-gradient(135deg, rgba(255,92,92,0.08), rgba(255,159,67,0.05))' }}>
